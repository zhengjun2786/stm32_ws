...
#define L_Pin GPIO_PIN_13
#define L_GPIO_Port GPIOB
#define right_8_Pin GPIO_PIN_8
#define right_8_GPIO_Port GPIOA
#define right_9_Pin GPIO_PIN_9
#define right_9_GPIO_Port GPIOA
...
#define left_6_Pin GPIO_PIN_6
#define left_6_GPIO_Port GPIOB
#define left_7_Pin GPIO_PIN_7
